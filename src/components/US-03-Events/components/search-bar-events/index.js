...
export default function SearchBarEvents(props) {
  ...
  return (
    <div className='searchBarContainer'>
      <label htmlFor='searchByLabel' className='searchByLabel'>
        SEARCH BY:
      </label>
      <select
        className='selectCategoryOption'
        name='eventSearchSelection'
        id='eventSearchSelection'
      ...
      {selectedSearchCategory === searchCategories[3] ? (
        <input
          placeholder='provide the keyword'
          className='inputSearchCategory'
      ...
      <button
        className='searchByCategoryButton'
